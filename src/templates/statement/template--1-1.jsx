...
import BGStatement11Blue from "../../assets/backgrounds/statement/1-1/blue";
import BGStatement11Green from "../../assets/backgrounds/statement/1-1/green";
import BGStatement11Purple from "../../assets/backgrounds/statement/1-1/purple";
import BGStatement11Yellow from "../../assets/backgrounds/statement/1-1/yellow";
      ...
      >
        ...
        <div className="absolute top-0 left-0 w-full h-full z-30 px-3 pt-3 pb-1 flex flex-col">
          ...
          <div className="flex">
            ...
            <div className="self-end hidden">PartnerLogo</div>
          </div>
        </div>
      </div>
    </div>
